...
final class XMLTest extends TestCase
{
     ...
     * 测试解析有效XML
     */
    public function testParseWithValidXml(): void
    {
     ...
     * 测试解析嵌套XML
     */
    public function testParseWithNestedXml(): void
    {
     ...
     * 测试从简单数组构建XML
     */
    public function testBuildWithSimpleArray(): void
    {
        $array = [
            'name' => 'test',
            'value' => 123,
     ...
     * 测试从嵌套数组构建XML
     */
    public function testBuildWithNestedArray(): void
    {
        $array = [
            'user' => [
                'name' => 'test',
     ...
     * 测试自定义根节点
     */
    public function testBuildWithCustomRoot(): void
    {
        $array = [
            'name' => 'test',
            'value' => 123,
     ...
     * 测试自定义项节点
     */
    public function testBuildWithCustomItem(): void
    {
        $array = [
            0 => 'first',
            1 => 'second',
     ...
     * 测试CDATA封装
     */
    public function testCdataEnclosesStringInCdata(): void
    {
        $string = 'test string';
     ...
     * 测试处理数字键的数组
     */
    public function testBuildWithNumericKeys(): void
    {
        $array = [
            'items' => [
                0 => 'first',
     ...
     * 测试处理带自定义ID属性的数组
     */
    public function testBuildWithCustomIdAttribute(): void
    {
        $array = [
            'items' => [
                0 => 'first',
     ...
     * 测试解析空XML
     */
    public function testParseWithEmptyXml(): void
    {
        $xml = '<xml></xml>';
        $result = XML::parse($xml);
